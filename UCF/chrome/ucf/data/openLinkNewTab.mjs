/**
@UCF @param {"prop":"JsBackground","module":{"name":"openLinkNewTab","child":{"events":{"mousedown":{"capture":true}}},"allFrames":true,"safeForUntrustedWebProcess":true,"messageManagerGroups":["browsers"],"matches":["<all_urls>"]},"disable":true} @UCF
*/
const lazy = {
    allInNewTab: false,
    get excludeTags() {

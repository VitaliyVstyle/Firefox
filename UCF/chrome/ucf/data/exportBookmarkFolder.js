...
(async (
    ...
    get dps() {
        delete this.dps;
        return this.dps = windowRoot.window.DownloadPaths || ChromeUtils.importESModule("resource://gre/modules/DownloadPaths.sys.mjs").DownloadPaths;
    },
    get exporter() {
        delete this.exporter;
        return this.exporter = windowRoot.window.UcfPrefs.dbg.ref("BookmarkExporter",
            (windowRoot.window.BookmarkHTMLUtils || ChromeUtils.importESModule("resource://gre/modules/BookmarkHTMLUtils.sys.mjs").BookmarkHTMLUtils).exportToFile);
    },
    init() {

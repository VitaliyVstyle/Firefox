/**
@UCF @param {"prop":"JsAllChrome.load","urlregxp":"^chrome:\\/\\/browser\\/content\\/(?:browser|places\\/(?:bookmarksSidebar|places))\\.xhtml","disable":true} @UCF
@UCF @param {"prop":"JsContent.pageshow","urlregxp":"^chrome:\\/\\/browser\\/content\\/(?:browser|places\\/(?:bookmarksSidebar|places))\\.xhtml","disable":true} @UCF
*/
(async (
    ...
    get dps() {
        delete this.dps;
        return this.dps = (windowRoot.window || windowRoot.ownerGlobal).DownloadPaths || ChromeUtils.importESModule("resource://gre/modules/DownloadPaths.sys.mjs").DownloadPaths;
    },
    get exporter() {
        delete this.exporter;
        return this.exporter = (windowRoot.window || windowRoot.ownerGlobal).UcfPrefs.dbg.ref("BookmarkExporter",
            ((windowRoot.window || windowRoot.ownerGlobal).BookmarkHTMLUtils || ChromeUtils.importESModule("resource://gre/modules/BookmarkHTMLUtils.sys.mjs").BookmarkHTMLUtils).exportToFile);
    },
    init() {

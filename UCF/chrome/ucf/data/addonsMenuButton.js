...
(async (
    ...
    image = (size = "width='16' height='16'") => `data:image/svg+xml;charset=utf-8,<svg xmlns='http://www.w3.org/2000/svg' ${size} viewBox='0 0 16 16'><path style='fill:none;stroke:context-fill rgb(142, 142, 152);stroke-opacity:context-fill-opacity;stroke-width:1.1;stroke-linecap:round;stroke-linejoin:round;' d='M12.9 15.3H3.2c-.88 0-1.6-.6-1.6-1.4v-2.7c0-.4.33-.6.74-.6h1.72c.7 0 1.25-.64 1.25-1.2 0-.64-.55-1.15-1.25-1.15H2.34c-.41 0-.74-.32-.74-.68V5.84c0-.81.72-1.48 1.6-1.48h2.36V3.13c0-1.21.93-2.297 2.21-2.419C9.23.57 10.5 1.62 10.5 2.98v1.38h2.4c.9 0 1.5.67 1.5 1.48v8.06c0 .8-.6 1.4-1.5 1.4z'/></svg>`,
    img_opts = "data:image/svg+xml;charset=utf-8,<svg xmlns='http://www.w3.org/2000/svg' height='16' width='16' viewBox='0 0 16 16'><g style='fill:none;stroke:context-fill rgb(142, 142, 152);stroke-opacity:context-fill-opacity;stroke-width:1.1;stroke-linecap:round;stroke-linejoin:round;'><path d='M8.66 15.4h-1.2c-.69 0-1.3-.5-1.5-1.2L5.58 13c-.26-.1-.51-.3-.76-.5l-1.41.4c-.65.1-1.37-.1-1.72-.8l-.6-.9c-.342-.7-.252-1.45.22-1.87l1-1v-.81l-.99-.97C.842 6.06.748 5.36 1.1 4.78l.6-.98c.34-.58 1.05-.87 1.7-.72l1.44.32c.26-.16.5-.3.74-.41l.38-1.27c.2-.64.81-1.089 1.5-1.091h1.2c.69 0 1.28.441 1.34 1.071l.4 1.3c.3.11.5.25.8.4l1.3-.32c.7-.15 1.5.14 1.8.72l.6.98c.4.57.3 1.28-.2 1.77l-1 .97v.81l1 1c.5.42.6 1.17.2 1.87l-.6.9c-.3.7-1.1.9-1.8.8l-1.3-.4c-.3.2-.5.4-.8.5l-.4 1.2c-.1.7-.64 1.2-1.34 1.2'/><circle cx='8' cy='8' r='2.4'/></g></svg>",
    img_copy = "data:image/svg+xml;charset=utf-8,<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 16 16'><path style='fill:none;stroke:context-fill rgb(142, 142, 152);stroke-opacity:context-fill-opacity;stroke-width:1.1;stroke-linecap:round;stroke-linejoin:round;' d='M6 .5h6c.8 0 1.5.7 1.5 1.5v10c0 .8-.7 1.5-1.5 1.5H6c-.8 0-1.5-.7-1.5-1.5V2c0-.8.7-1.5 1.5-1.5m5.5 15H5c-1.5 0-2.5-1-2.5-2.5V2.5'/></svg>",
    img_open = "data:image/svg+xml;charset=utf-8,<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 16 16'><path style='fill:none;stroke:context-fill rgb(142, 142, 152);stroke-opacity:context-fill-opacity;stroke-width:1.1;stroke-linecap:round;stroke-linejoin:round;' d='M8 1 .6 8.4h1v5c0 1 1 2 2 2h8.8c1 0 2-1 2-2v-5h1zm2.4 14v-4c0-3.2-4.8-3.2-4.8 0v4'/></svg>",
    img_view = "data:image/svg+xml;charset=utf-8,<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 16 16'><path style='fill:none;stroke:context-fill rgb(142, 142, 152);stroke-opacity:context-fill-opacity;stroke-width:1.1;stroke-linecap:round;stroke-linejoin:round;' d='m5.5 14.5 5-13m-7 10-3-3 3-3m9 0 3 3-3 3'/></svg>",
    img_unins = "data:image/svg+xml;charset=utf-8,<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 16 16'><path style='fill:none;stroke:context-fill rgb(227, 27, 93);stroke-opacity:context-fill-opacity;stroke-width:1.1;stroke-linecap:round;stroke-linejoin:round;' d='M4.5 1.5v1m6 0H1c-.6 0-.6 1 0 1h.5V9c0 4 1.5 6.5 2.5 6.5h7c1 0 2.5-2.5 2.5-6.5V3.5h.5c.6 0 .6-1 0-1zm0 0v-1c0-.5-.5-1-1-1h-4c-.5 0-1 .5-1 1m0 4v7m3-7v7m3-7v7'/></svg>", show_version = true,

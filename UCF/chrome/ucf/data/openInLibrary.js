/**
@UCF @param {"prop":"JsAllChrome.load","urlregxp":"^chrome:\\/\\/browser\\/content\\/(?:browser|places\\/bookmarksSidebar)\\.xhtml","disable":true} @UCF
@UCF @param {"prop":"JsContent.pageshow","urlregxp":"^chrome:\\/\\/browser\\/content\\/(?:browser|places\\/bookmarksSidebar)\\.xhtml","disable":true} @UCF
*/
(async (
    ...
    open({ triggerNode: tn, _view: vw }) {
        ...
        win = (windowRoot.window || windowRoot.ownerGlobal).openDialog("chrome://browser/content/places/places.xhtml", "", "chrome,toolbar=yes,dialog=no,resizable");
